...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.le_skeleton = QtGui.QLineEdit(self.centralwidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.le_skeleton.sizePolicy().hasHeightForWidth())
        self.le_skeleton.setSizePolicy(sizePolicy)
        self.le_skeleton.setMinimumSize(QtCore.QSize(200, 0))
        self.le_skeleton.setObjectName("le_skeleton")
        self.horizontalLayout.addWidget(self.le_skeleton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(QtGui.QApplication.translate("MainWindow", "Skeleton:", None, QtGui.QApplication.UnicodeUTF8))
        self.le_skeleton.setText(QtGui.QApplication.translate("MainWindow", "\\animals\\", None, QtGui.QApplication.UnicodeUTF8))
